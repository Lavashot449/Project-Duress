...
|---|---|---|
| What Was | What happened; persisted by the Deep. | Persistence principle FROZEN; fuller account S03 working model. |
...
| Manifestation — causal use | Possibility gaining actuality and producing What Was. | S03 working model. |
| Manifestation — Echo production use | The assembled Echo after its individual components. | S02 HISTORICAL project workflow. |
| Communion | Reflective use of the cycle to examine and learn from outcomes. | S03 working model. |
